...
<head>
    ...
    <title>Sistem Informasi Izin Usaha Apotek</title>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-3 text-info text-center">
                                        <a href="<?php echo base_url('ia/apotek') ?>">
                                            <p class="nav-link small text-info">DATA APOTEK</p>
                                            <i class="fas fa-3x fa-clinic-medical text-info"></i>
                                        </a>
                                    </div>

                                    <div class="col-md-3 text-info text-center">
                                        <a href="<?php echo base_url('ia/obat') ?>">
                                            <p class="nav-link small text-info">DATA TOKO OBAT</p>
                                            <i class="fas fa-3x fa-prescription-bottle-alt text-info"></i>
                                        </a>
                                    </div>
                                </div>
                                <hr>
