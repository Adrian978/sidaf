...
class PkpcetakExport extends CI_Controller
{
  ...
  {
    $data['pkpcetak'] = $this->ModelExport->pkpcetak();
  }
  ...
  public function export()
  {
    ...
    $excel->getProperties()->setCreator('My Notes Code')
      ...
      ->setTitle("Data PKP CETAK")
      ->setSubject("PKP Cetak")
      ->setDescription("Laporan Semua Tanda Terima PKP Cetak")
      ->setKeywords("Data PKP Cetak");
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA PKP CETAK"); // Set kolom A1 dengan tulisan "DATA PKP CETAK"
    $excel->getActiveSheet()->mergeCells('A1:G1'); // Set Merge Cell pada kolom A1 sampai Q1
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('E3', "CETAK PKP"); // Set kolom E3 dengan tulisan "ALAMAT"
    ...
    // Panggil function view yang ada di ModelExport untuk menampilkan semua data PKP Cetak
    $pkpcetak = $this->ModelExport->pkpcetak();
    ...
    $excel->getActiveSheet(0)->setTitle("Laporan Data PKP Cetak");
    $excel->setActiveSheetIndex(0);
    // Proses file excel
    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment; filename="Data PKP Cetak.xlsx"'); // Set nama file excel nya
